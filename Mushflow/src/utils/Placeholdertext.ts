export const PlaceholderText = [
    "Type your thoughts, let them sprout! 🍄",
    "Jot it down before it disappears! ✨",
    ...
    "Write, plan, create! 🚀",
    "Brain dump time! 🧠",
    "Capture your next big thing! 🔥",
    "Sketch it out, make it real! 🎨",
    "One thought at a time... ⏳",
    "Start your next masterpiece... ✍️",
    "Organize the chaos in your head! 🌪️",
    "No idea is too small to note down! 📝",
